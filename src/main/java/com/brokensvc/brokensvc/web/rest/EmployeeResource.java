...
import com.brokensvc.brokensvc.web.rest.errors.BadRequestAlertException;
import com.brokensvc.brokensvc.web.rest.util.HeaderUtil;
...
@CrossOrigin(origins = "*", allowedHeaders = "*") public class EmployeeResource {
    ...
    private static final String ENTITY_NAME = "brokensvcEmployee";
